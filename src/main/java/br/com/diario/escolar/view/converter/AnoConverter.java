...
public class AnoConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Ano) {
            Ano o = (Ano) object;
            return getStringKey(o.getSeqAno());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Ano.class.getName()});
            return null;
        }
    }
