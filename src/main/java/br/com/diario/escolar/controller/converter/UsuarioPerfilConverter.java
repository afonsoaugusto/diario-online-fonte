...
import br.com.diario.escolar.controller.session.UsuarioPerfilFacade;
...
public class UsuarioPerfilConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof UsuarioPerfil) {
            ...
            return getStringKey(o.getSeqUsuarioPerfil());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), UsuarioPerfil.class.getName()});
            return null;
        }
    }
