...
@FacesConverter(value = "presencaConverter")
public class PresencaConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Presenca) {
            Presenca o = (Presenca) object;
            return getStringKey(o.getSeqPresenca());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Presenca.class.getName()});
            return null;
        }
    }
